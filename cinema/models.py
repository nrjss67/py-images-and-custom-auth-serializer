...
def upload_image_name(instance: "Movie", image_name):
    return f"{slugify(instance.title)}-{uuid.uuid4}{pathlib.Path(image_name).suffix}" # noqa
...
class Movie(models.Model):
    ...
    image = models.ImageField(null=True, upload_to=upload_image_name)
